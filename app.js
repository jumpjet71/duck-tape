...
(function () {
    ...
    var express = require('express'),
        ...
        globals = require('./src/main/javascript/utils/globals-utils').appGlobals,
        app = express();
    ...
    globals.setMode(require('./src/main/javascript/utils/mode-parser-utils.js').modeParser(process));
